...
public class AutonomousGenericAmpScore extends SequentialCommandGroup {
  /** Creates a new AutonomousRedAmpScore. */
  public AutonomousGenericAmpScore(DriveTrain driveTrain, Shooter shooter, Intake intake, double direction) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new AutonomousDriveDistance(driveTrain, 0, 0.2, 4.9),
        new AutonomousTurn(driveTrain, 0.1 * direction, 80),
